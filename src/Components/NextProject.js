function NextProject() {
  return (
    <div className="w-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300">
      <div className="shadow-md my-0 mx-auto bg-slate-400 mb-10 rounded-lg w-4/6 h-96 flex justify-center items-center">
        <h3 className="text-white text-7xl">COMING SOON</h3>
      </div>
